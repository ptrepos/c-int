...
// •œŒ³–@‚à‚Ç‚«
int mg_uint128_div_recovering_method_impl(
	mg_uint128 *op1,
	int op1_bits,
...
// •œŒ³–@œZƒx[ƒX‚ÌSRTœZ‚Ì‚æ‚¤‚È•Ï‘¥œZ
int mg_uint128_div_srt_impl(
...
MG_PRIVATE int mg_uint128_div_recovering_method(
	const mg_uint128 *op1, 
	const mg_uint128 *op2, 
	/*out*/mg_uint128 *quotient, 
	/*out*/mg_uint128 *reminder)
{
	...
	int op1_bits = mg_uint128_get_bit_size(&_op1);
	...
	err = mg_uint128_div_recovering_method_impl(
		/*inout*/&_op1, op1_bits, 
		op2, op2_bits,
		/*out*/quotient);
	if (err != 0)
...
MG_PRIVATE int mg_uint128_div_srt(
	const mg_uint128 *op1, 
	const mg_uint128 *op2, 
	/*out*/mg_uint128 *quotient, 
	/*out*/mg_uint128 *reminder)
